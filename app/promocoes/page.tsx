...
export default function PromocoesPage() {
  ...
  <div style={headerConteudo}>
    ...
    <div>
      ...
      <h1 style={tituloHeader}>Promoções</h1>

      <p style={subtituloHeader}>
        Crie campanhas promocionais, descontos e mensagens para WhatsApp.
      </p>

      <div style={linhaBadgesHeader}>
        <span style={badgeEmpresa}>🏢 {empresa?.nome || 'Meu Estúdio'}</span>
        <span style={badgeModulo}>📣 Marketing</span>
  ...
  <div style={acoesHeader}>
    ...
    <button onClick={sair} style={botaoHeaderSair}>
      Sair
    </button>
  </div>
</header>
